            ...
            <div class="page-sidebar text-center">
                ...
                <img src="{{ url('Front/assets/imgs/avatar.jpg') }}" alt="" class="circle-100 mb-3">
                ...
                <div class="row px-3">
                    <div class="col-4 p-1 figure">
                        <a href="#" class="figure-img">
                            <img src="{{ url('Front/assets/imgs/insta-1.jpg') }}" alt="">
                        </a>
                    </div>
                    <div class="col-4 p-1 figure">
                        <a href="#" class="figure-img">
                            <img src="{{ url('Front/assets/imgs/insta-2.jpg') }}" alt="" class="w-100 m-0">
                        </a>
                    </div>
                    <div class="col-4 p-1 figure">
                        <a href="#" class="figure-img">
                            <img src="{{ url('Front/assets/imgs/insta-3.jpg') }}" alt="" class="w-100">
                        </a>
                    </div>
                    <div class="col-4 p-1 figure">
                        <a href="#" class="figure-img">
                            <img src="{{ url('Front/assets/imgs/insta-4.jpg') }}" alt="" class="w-100 m-0">
                        </a>
                    </div>
                    <div class="col-4 p-1 figure">
                        <a href="#" class="figure-img">
                            <img src="{{ url('Front/assets/imgs/insta-5.jpg') }}" alt="" class="w-100">
                        </a>
                    </div>
                    <div class="col-4 p-1 figure">
                        <a href="#" class="figure-img">
                            <img src="{{ url('Front/assets/imgs/insta-6.jpg') }}" alt="" class="w-100 m-0">
                        </a>
                    </div>
                </div>
                ...
                <figure class="figure mt-5">
                    <a href="single-post.html" class="figure-img">
                        <img src="{{ url('Front/assets/imgs/img-4.jpg') }}" alt="" class="w-100">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-header p-0">
                        <div class="blog-media">
                            <img src="{{ url('Front/assets/imgs/blog-6.jpg') }}" alt="" class="w-100">
                ...
                <div class="media text-left mb-4">
                    <a href="single-post.html" class="overlay-link"></a>
                    <img class="mr-3" src="{{ url('Front/assets/imgs/blog-1.jpg') }}" width="100px" alt="Generic placeholder image">
                ...
                <div class="media text-left mb-4">
                    <a href="single-post.html" class="overlay-link"></a>
                    <img class="mr-3" src="{{ url('Front/assets/imgs/blog-2.jpg') }}" width="100px" alt="Generic placeholder image">
                    <div class="media-body">
                ...
                <div class="media text-left mb-4">
                    <a href="single-post.html" class="overlay-link"></a>
                    <img class="mr-3" src="{{ url('Front/assets/imgs/blog-3.jpg') }}" width="100px" alt="Generic placeholder image">
                    <div class="media-body">
